...
def register() -> None:
    ...
    import providers
    from providers.rag.provider import RagProvider

    if not _CONFIG_PATH.exists():
        log.error("rag_config_missing", path=str(_CONFIG_PATH))
        return
    ...
    providers.register_provider(RagProvider(cfg))
